...
VALUES ('Conservator, furniture', 110000, 0, 'watson-davis'),
       ...
       ('Counsellor', 80000, 0, 'owen-newton'),
       ('Financial controller', 80000, 0, 'sellers-bryant'),
       ('Advertising account executive', 80000, 0, 'thomas-sons'),
       ('Buyer, industrial', 80000, NULL, 'reynolds-greene'),
       ('Interpreter', 55000, 0, 'hudson-inc'),
       ('Best boy', 80000, 0, 'jackson-sons'),
       ('Freight forwarder', 183000, 0, 'hudson-inc'),
       ('Designer, jewellery', 80000, 0, 'weber-hernandez'),
       ('Tree surgeon', 80000, 0.001, 'hall-davis'),
       ...
       ('Art gallery manager', 80000, 0.085, 'anderson-arias-morrow'),
       ...
       ('Transport planner', 80000, NULL, 'reynolds-greene'),
       ('Bonds trader', 80000, NULL, 'mitchell-brown'),
       ...
       ('Water engineer', 80000, 0.028, 'mejia-scott-ryan'),
       ('Engineer, energy', 80000, 0.048, 'arnold-berger-townsend'),
       ('Plant breeder/geneticist', 80000, 0.081, 'thomas-sons'),
       ('Oceanographer', 80000, 0.097, 'anderson-arias-morrow'),
       ('Clinical cytogeneticist', 152000, 0.027, 'mitchell-brown'),
       ('Nature conservation officer', 82000, 0.093, 'watson-davis'),
       ('Insurance underwriter', 80000, 0.008, 'hall-davis'),
       ('Chief of Staff', 110000, 0.016, 'scott-smith'),
       ('Surveyor, insurance', 80000, 0.066, 'foster-rice'),
       ('Surveyor, building control', 80000, NULL, 'reynolds-greene'),
       ('Trade mark attorney', 80000, NULL, 'mueller-moore'),
